...
/**
 * Sets the Result Image to a sad Smiley if points are less than 3
 * Sets the Result Image to Trophy if points are more or equal than 3
 */
function setResultImg() {
    if (playerPoints < 3) {
        document.getElementById('resultPic').src = 'src/img/smiley.png';
        var audio = new Audio('src/sounds/boo.wav');
